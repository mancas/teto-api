...
start:
	@docker run --name jose_rest_api_container -p 3000:3000 --net joseweb -v /Users/manu/Documents/Images/jose:/opt/api/albums -d mancas/mancas:jose_rest_api_$(VERSION)
